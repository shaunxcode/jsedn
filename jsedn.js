...
// Generated by CoffeeScript 1.6.2
(function() {
  var Discard, Iterable, Keyword, List, Map, Pair, Prim, Set, StringObj, Symbol, Tag, Tagged, Vector, encode, encodeHandlers, encodeJson, escapeChar, fs, handleToken, kw, lex, parenTypes, parens, parse, read, specialChars, sym, tagActions, tokenHandlers, type, typeClasses, _ref, _ref1, _ref2, _ref3, _ref4,
    __indexOf = [].indexOf || function(item) { for (var i = 0, l = this.length; i < l; i++) { if (i in this && this[i] === item) return i; } return -1; };

  type = require("./type");

  _ref = require("./atoms"), Prim = _ref.Prim, Symbol = _ref.Symbol, Keyword = _ref.Keyword, StringObj = _ref.StringObj, Discard = _ref.Discard, kw = _ref.kw, sym = _ref.sym;
...
// Generated by CoffeeScript 1.6.2
(function() {
  var StringObj, Tag, handleToken, kw, sym, tokenHandlers, _ref;

  _ref = require("./atoms"), StringObj = _ref.StringObj, kw = _ref.kw, sym = _ref.sym;
